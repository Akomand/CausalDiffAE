...
class Trainer:
    def __init__(self, model, optimizer, train_loader, val_loader, gpu_id=0, dataset="pendulum", save_every=None):
    ...
    def train(self):
        ...
        for epoch in range(100):
            ...
            if avg_val_loss < best_loss:
                ...
                model_path = 'classifier_shadowpos_best.pth'
    ...
    def save_checkpoint(self, model_path):
        ...
        torch.save(self.model.state_dict(), f'../results/pendulum/classifier/{model_path}')
